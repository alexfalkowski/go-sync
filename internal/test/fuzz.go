...
// FuzzMapStringIntOperations exercises Map operations against a plain map model.
...
// FuzzMapNilInterfaceRoundTrip exercises Map with nil interface keys and values.
...
// FuzzValueIntOperations exercises Value operations against an integer model.
func FuzzValueIntOperations(t *testing.T, data []byte) {
	t.Helper()
...
// FuzzBufferPoolCopyAndReset verifies BufferPool copy isolation and put reset behavior.
func FuzzBufferPoolCopyAndReset(t *testing.T, data []byte) {
	t.Helper()
...
// FuzzErrorsGroupJoinOrder verifies ErrorsGroup joins errors in Go call order.
func FuzzErrorsGroupJoinOrder(t *testing.T, data []byte) {
	t.Helper()
...
// FuzzWorkerTryScheduleCapacity verifies TrySchedule admission against worker capacity.
func FuzzWorkerTryScheduleCapacity(t *testing.T, limitRaw int, attemptsRaw int) {
	t.Helper()
